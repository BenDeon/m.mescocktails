...
/**
 * EventsIngredientSelection
 *
 * @ORM\Table(name="events_ingredient_selection", indexes={@ORM\Index(name="event", columns={"event", "cocktail"})})
 * @ORM\Entity
 */
class EventsIngredientSelection
{
    /**
     * @var int
     *
